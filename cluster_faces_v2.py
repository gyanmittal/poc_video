...
class FaceCacheDB:
    ...
    def _ensure_schema(self) -> None:
        ...
        # Ensure run_id column exists to scope dedup per run
        self.con.execute(
            "ALTER TABLE faces ADD COLUMN IF NOT EXISTS run_id TEXT;"
        )
...
def main():
    p = argparse.ArgumentParser(description="Extract prominent faces from videos and cluster similar faces (v2)")
